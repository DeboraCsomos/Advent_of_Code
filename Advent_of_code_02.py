...
def main():
    probe = [[5, 9, 2, 8], [9, 4, 7, 3], [3, 8, 6, 5]]
    probe2 = [[6, 2, 5, 11], [8, 4, 3, 7], [9, 7, 3, 10]]
    numbers_list = [[6046,   6349,  208,  276,  4643,  1085,  1539,  4986,  7006,  5374,  252,  4751,  226,  6757,  7495,  2923],
    ...
    print(checksum2(probe))
    print(checksum2(probe2))
    print(checksum2(numbers_list))
